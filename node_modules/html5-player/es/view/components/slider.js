...
var Slider = (_temp2 = _class = function (_React$Component) {
  ...
  function Slider() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Slider.__proto__ || _Object$getPrototypeOf(Slider)).call.apply(_ref, [this].concat(args))), _this), _this.displayName = 'Slider', _this.state = {}, _this.dispatch = _this.props.dispatch, _this.percent = 0, _this.events = [], _this.eventsAfterMouseDown = [], _this.onEnd = function (e) {
      e.stopPropagation();
  ...
  _createClass(Slider, [{
    ...
    value: function bindEvents() {
      ...
      this.events.push(addEventListener(this.sliderContainerDOM, 'mousedown', this.onMouseDown));
      this.events.push(addEventListener(this.sliderContainerDOM, 'mouseup', this.onMouseUp));
    }
  }, {
    ...
    value: function bindEventsAfterMouseDown() {
      ...
      this.eventsAfterMouseDown.push(addEventListener(this.document, 'mouseup', this.onEnd));
      this.eventsAfterMouseDown.push(addEventListener(this.sliderContainerDOM, 'mousemove', this.onMouseMove));
    }
  }, {
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        {
          ...
          className: classnames('html5-player-slider-container', {
