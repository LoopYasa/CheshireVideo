...
import { TIMEOUT_ERROR, LOAD_ERROR, CONTENT_PARSING_ERROR, UNKNOWN_ERROR, FATAL_ERROR } from '../utils/error-code';

var hlsAPI = function (_API) {
  _inherits(hlsAPI, _API);

  function hlsAPI(videoDOM, file, Hls) {
    var _temp, _this2, _ret;

    _classCallCheck(this, hlsAPI);

    var _this = (_temp = (_this2 = _possibleConstructorReturn(this, (hlsAPI.__proto__ || _Object$getPrototypeOf(hlsAPI)).call(this, videoDOM, file)), _this2), _this2.first = true, _temp);
    _this2.file = file;
    if (Hls.isSupported()) {
      _this2.Hls = Hls;
