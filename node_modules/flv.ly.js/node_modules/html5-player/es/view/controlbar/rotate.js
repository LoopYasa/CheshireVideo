...
var PlayPause = (_dec = connect(function (state) {
...
}), _dec2 = clearDecorator([rotateNamespace]), _dec(_class = _dec2(_class = (_temp2 = _class2 = function (_React$Component) {
  ...
  function PlayPause() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PlayPause.__proto__ || _Object$getPrototypeOf(PlayPause)).call.apply(_ref, [this].concat(args))), _this), _this.displayName = 'PlayPause', _this.state = {}, _this.dispatch = _this.props.dispatch, _this.rotate = function (e) {
      e.stopPropagation();
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('use', { xlinkHref: '#icon-rotate-left' })
        )
      );
    }
  }]);
