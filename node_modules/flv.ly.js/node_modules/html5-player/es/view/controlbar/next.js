...
var Next = (_temp2 = _class = function (_React$Component) {
  ...
  function Next() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Next.__proto__ || _Object$getPrototypeOf(Next)).call.apply(_ref, [this].concat(args))), _this), _this.displayName = 'Next', _this.onClick = function (e) {
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('use', { xlinkHref: '#icon-next' })
        )
      );
    }
  }]);
